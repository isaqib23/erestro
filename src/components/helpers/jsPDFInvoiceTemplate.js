...
function jsPDFInvoiceTemplate(props) {
  ...
  if (param.contact.email || param.invoice.text) {
    doc.text(10, currentHeight, param.contact.email);
    doc.text(docWidth - 10, currentHeight, param.invoice.text, "right");
    currentHeight += pdfConfig.subLineHeight;
  }

  if (param.invoice.text1) {
    doc.text(docWidth - 10, currentHeight, param.invoice.text1, "right");
    currentHeight += pdfConfig.subLineHeight;
  }
